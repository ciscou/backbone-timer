scrambler_222 = function() {
  /* Made by Tom van der Zanden, based on previous work by Jaap Scherphuis */
  ...
  */
  ...
  function help(){
    alert("Cube Scrambler\n\n"+
      "This program generates optimal scrambles for 2x2x2 cubes.\n"+
      "Enter the cube size, the number of scrambles you want,\n"+
      "and optionally the scramble minimum length. If you then\n"+
      ...
      "\nNotation:\n"+
      "Standard 2x2x2 FRU notation is used by this scrambler.\n"+
